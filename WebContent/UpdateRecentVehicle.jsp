...
<script>
	...
	<div id="wrapper">
		...
		<a href="RecentInstalledVehicle.jsp" class="waves-effect waves-light btn green" style="float: right;margin-right: 50px;">View User </a>
				 <br>
				 <br>
				<div id="page-inner">
	<%
...
String sql ="select * from vehicle.db1 where job_id="+id;
...
<div class="container">
 ...
 <h3 align="center"style="color:#4f7202;">UPDATE VEHICLE REGISTRATION  FORM</h3><BR>
	

<div class="row">
				<form action="UpdateRecentVehicleProcess.jsp" method="post"  >
					...
					<div class="row">
							<div class="col-sm-6 form-group">
								RegdNo
					            <input type="hidden" placeholder="Enter  Here.." value="<%=resultSet.getString(1) %>"  name="job_id" class="form-control">
								
								<input type="text" placeholder="Enter Regd_No Here.." value="<%=resultSet.getString(3) %>"  name="regd_no" class="form-control">
							</div>
							<div class="col-sm-6 form-group">
								Model
								<input type="text" placeholder="Enter Model No Here.." value="<%=resultSet.getString(4) %>"name="model" class="form-control">
							</div>
						</div>	
						<div class="row">
							<div class="col-sm-6 form-group">
								Mileage
								<input type="text" placeholder="Enter Mileage"  value="<%=resultSet.getFloat(5) %>" name="mileage" class="form-control" >
							</div>
							<div class="col-sm-6 form-group">
								Chassis_No
								<input type="text" placeholder="Enter Chassis_No Here.." value="<%=resultSet.getString(6) %>"name="chassis_no" class="form-control">
							</div>
						</div>	
						<div class="row">
							<div class="col-sm-6 form-group">
								Engine_No
								<input type="text" placeholder="Enter Engine_No Here.." value="<%=resultSet.getString(7) %>" name="engine_no" class="form-control">
							</div>
							<div class="col-sm-6 form-group">
								Manufacturing_Date
								<input type="date" placeholder="Enter Manufacturing_Date Here.." value="<%=resultSet.getString(8) %>"id="date" name="mdate" class="form-control">
							</div>
							<div class="col-sm-6 form-group">
								Service Date
								<input type="date" placeholder="Enter Service Date Here.." value="<%=resultSet.getString(9) %>"id="date" name="sdate" class="form-control" required>
							</div>
						</div>	
						    <h3 align="center"style="color:#4f7202;">USER REGISTRATION  FORM</h3><BR>
						
						<div class="well">
						<div class="row">
							<div class="col-sm-6 form-group">
								First Name
								<input type="text" placeholder="Enter First Name Here.." value="<%=resultSet.getString(10) %>" name="firstname" class="form-control">
							</div>
							<div class="col-sm-6 form-group">
								Last Name
								<input type="text" placeholder="Enter Last Name Here.."  value="<%=resultSet.getString(11) %>"name="lastname"class="form-control">
							</div>
						</div>					
						...
						<div class="row">
							<div class="col-sm-4 form-group">
								Email
								<input type="email" placeholder="Enter Email Here.."value="<%=resultSet.getString(12) %>" name="emailid" class="form-control" required>
							</div>	
							<div class="col-sm-4 form-group">
								Mobile No
								<input type="text" placeholder="Enter Mobile No Here.." value="<%=resultSet.getLong(16) %>"name="mobile_no" maxlength="10" class="form-control"required>
							</div>	
							<div class="col-sm-4 form-group">
								Gender
        ...
        <input type="radio" name="gender"  value="<%=resultSet.getString(14) %>"placeholder="Gender"style="position:relative; opacity:1;    left: 0px;
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								Pincode
								<input type="text" placeholder="Enter Designation Here.." value="<%=resultSet.getInt(17) %>"name="pincode" maxlength="6"  class="form-control">
							</div>	
							<div class="col-sm-6 form-group">
								Nature Of Job
								<input type="text" placeholder="Enter Nature Of Job Here..." value="<%=resultSet.getString(13) %>" name="nature" class="form-control">
							</div>		
						</div>						
					<div class="row">
					<div class="col-sm-6 form-group">
								
								<input type="hidden"  name="job_no" id="job_no" placeholder="job_no" value="<%=resultSet.getString(2) %>"class="form-control">
							</div>
