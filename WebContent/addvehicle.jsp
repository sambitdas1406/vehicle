...
<script>
	...
	<div id="wrapper">
		...
		<a href="view.jsp" class="waves-effect waves-light btn green" style="float: right;margin-right: 50px;">View User </a>
				 <br>
				 <br>
				<div id="page-inner">
...
<div class="container">
    <h1 align="center" style="color:#424bf4;"class="well">Registration Form</h1>
	...
	<div class="row">
				<form action="adduser.jsp" method="post"  >
					...
					<div class="row">
							<div class="col-sm-6 form-group">
								RegdNo
								<input type="text" placeholder="Enter Regd_No Here.." name="regd_no" class="form-control">
							</div>
							<div class="col-sm-6 form-group">
								Model
								<input type="text" placeholder="Enter Model No Here.." name="model" class="form-control">
							</div>
						</div>	
						<div class="row">
							<div class="col-sm-6 form-group">
								Mileage
								<input type="text" placeholder="Enter Mileage" name="mileage" class="form-control" >
							</div>
							<div class="col-sm-6 form-group">
								Chassis_No
								<input type="text" placeholder="Enter Chassis_No Here.." name="chassis_no" class="form-control">
							</div>
						</div>	
						<div class="row">
							<div class="col-sm-6 form-group">
								Engine_No
								<input type="text" placeholder="Enter Engine_No Here.."name="engine_no" class="form-control">
							</div>
							<div class="col-sm-6 form-group">
								Manufacturing_Date
								<input type="date" placeholder="Enter Manufacturing_Date Here.." id="date" name="mdate" class="form-control">
							</div>
							<div class="col-sm-6 form-group">
								Service Date
								<input type="date" placeholder="Enter Service Date Here.." id="date" name="sdate" class="form-control" required>
							</div>
						</div>	
						...
						<div class="row">
							<div class="col-sm-4 form-group">
								Email
								<input type="email" placeholder="Enter Email Here.." name="emailid" class="form-control" required>
							</div>	
							<div class="col-sm-4 form-group">
								Mobile No
								<input type="text" placeholder="Enter Mobile No Here.." name="mobile_no" maxlength="10" class="form-control"required>
							</div>	
							<div class="col-sm-4 form-group">
								Gender
        ...
        <input type="radio" name="gender" value ="female "placeholder="Gender"style="position:relative; opacity:1;    left: 0px;
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								Pincode
								<input type="text" placeholder="Enter Designation Here.." name="pincode" maxlength="6"  class="form-control">
							</div>	
							<div class="col-sm-6 form-group">
								Nature Of Job
								<input type="text" placeholder="Enter Nature Of Job Here..." name="nature" class="form-control">
							</div>		
						</div>						
					<div class="row">
					<div class="col-sm-6 form-group">
								
								<input type="hidden"  name="job_no" id="job_no" placeholder="job_no" class="form-control">
							</div>
