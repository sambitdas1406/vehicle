...
String sqlPgintn="SELECT SQL_CALC_FOUND_ROWS * FROM vehicle.salary limit "+iPagNo+","+iSwRws+"";
...
<TD><%=rsPgin.getFloat(5)%></TD>
<td style="padding:12px 20px;    margin-right: 10px;"class="btn orange"><a href="UpdateSalary.jsp?id=<%=rsPgin.getString("id")%>"><i style="color:#ffff" class="fa fa-edit" ></i></a></td>
