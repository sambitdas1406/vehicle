...
<div class="container">
 ...
 <h3 align="center"style="color:#4f7202;">EMPLOYEE REGISTRATION  FORM</h3><BR>
	...
	<div class="row">
				<form action="AddEmployeeDB.jsp" method="post"  >
					...
					<div class="row">
						...
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								Date Of Birth
								<input type="date" placeholder="Enter 	Date Of Birth Here.." id="date" name="dob" class="form-control" required>
							</div>
						</div>	
						...
						<div class="row">
							...
							<div class="col-sm-4 form-group">
								Mobile No
								<input type="text" placeholder="Enter Mobile No Here.." name="phone" maxlength="10" class="form-control"required>
							</div>	
							<div class="col-sm-4 form-group">
								Gender
        ...
        <input type="radio" name="gender" value ="female "placeholder="Gender"style="position:relative; opacity:1;    left: 0px;
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								Pincode
								<input type="text" placeholder="Enter Pincode Here.." name="pincode" maxlength="6"  class="form-control">
							</div>	
							<div class="col-sm-6 form-group">
								Employee Salary
								<input type="text" placeholder="Enter Employee Salary Here..." name="salary" class="form-control">
							</div>		
						</div>						
