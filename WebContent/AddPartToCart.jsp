		...
		<nav class="navbar navbar-default top-navbar" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand waves-effect waves-dark" href="home1.jsp"><i
					class="large material-icons"></i> <strong
		...
		<nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a href="#" class="waves-effect waves-dark"><i
							class="fa fa-table"></i> Vehicle <span
							class="fa arrow fa-angle-right"></span></a>
						<ul class="nav nav-second-level">
...
<div class="container">
  ...
  <form action="carts.jsp" method="post">				
					...
					<div class="row">
					 <input type="hidden" name="id" value="<%=u.getId() %>"/>  
							<div class="col-sm-6 form-group">
								PartName
								<input type="text" name="item" spellcheck="false" value="<%= u.getPartname()%>" class="form-control">
							</div>
				...
				<!--    <input type="submit" value="Add part" name="add">
              <input type="submit" value="List part" name="list">-->
